...
//  
//*********************************************************
// https://github.com/microsoft/AppModelSamples/blob/master/Samples/BananaEdit/BananaEdit/Program.cs
        ...
        static void Main(string[] args)
        {
            ...
            if (activatedArgs is FileActivatedEventArgs fileArgs)
            {
                ...
                if (file != null)
                {
                    ...
                    if (instance.IsCurrentInstance)
                    {
                        ...
                        global::Windows.UI.Xaml.Application.Start((p) => new Application());
                    }
                    else
                    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        AppInstance.FindOrRegisterInstanceForKey("REUSABLE" + Application.Id.ToString());
                        UpdateSharedInstanceNumber();
                        global::Windows.UI.Xaml.Application.Start((p) => new Application());
                    }
                }
